...
const TermsOfUsePage = () => {
  ...
  const fetchContent = async () => {
    ...
    setError(false)
    try {
      const response = await api.get('/api/content/terms-of-use/')
  ...
  return (
    <div className="legal-page">
      <div className="legal-header">
        ...
        <h1 className="header-title">Conditions d'utilisation</h1>
      </div>
      ...
      <div className="legal-content">
        ...
        {error && (
          <div className="legal-error">
            <p>Impossible de charger les conditions d'utilisation.</p>
